...
#ifndef _ITE_CORE_TYPES_H_
#define _ITE_CORE_TYPES_H_

#if 0

// redefinition of bitfields to avoid conflict with zephyr
...
// bool type TRUE and FALSE already defined by zephyr, as "true" and "false"
...
typedef volatile unsigned char XBYTE;         // external ram
typedef volatile unsigned int XWORD;          // external ram
typedef volatile unsigned long int LWORD;     // external ram
typedef unsigned char BYTE;
typedef volatile unsigned short WORD;
typedef volatile unsigned short IWORD;     // internal ram
typedef volatile unsigned char BBYTE;     // bit addressing ram
typedef volatile unsigned char IBYTE;     // internal ram direct
typedef volatile unsigned char IIBYTE;    // internal ram indirect
typedef volatile unsigned char *PORT_BYTE_PNTR;
typedef volatile unsigned char ECReg;
